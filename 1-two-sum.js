...
we will find it once we get to the second number. The point of this is so there is no self-matching (ex. index0 and index0)
which would be invalid, so there is no need to do a check like on line 14. And we can do it in one loop.
 */
